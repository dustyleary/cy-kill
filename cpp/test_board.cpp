...
TEST_F(Empty19, countLiberties) {
    ...
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(0,0));
...
TEST_F(Empty19, sharedLiberties) {
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(1,1));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(2,1));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(3,1));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(1,2));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(3,2));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(1,3));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(2,3));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(3,3));
...
TEST_F(Empty19, enemyRemovesLiberties) {
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(1,1));
    EXPECT_EQ(4, b.countLiberties(POS(1,1)));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(2,1));
...
TEST_F(Empty19, surroundingRemovesLiberties) {
    ...
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(2,0));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(2,1));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(2,2));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(1,2));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(0,2));
...
TEST_F(Empty19, isSuicide) {
    ...
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(1,1));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(1,0));
    EXPECT_EQ(true, b.isSuicide(BoardState::WHITE(), POS(0,0)));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(0,2));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(1,2));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(2,2));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(2,1));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(2,0));
    EXPECT_EQ(1, b.countLiberties(POS(0,1)));
    EXPECT_EQ(false, b.isSuicide(BoardState::WHITE(), POS(0,0)));
}

TEST_F(Empty19, isSuicide2) {
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(0,0));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(2,0));

    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(0,1));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(1,1));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(2,1));

    EXPECT_EQ(false, b.isSuicide(BoardState::WHITE(), POS(1,0)));
    EXPECT_EQ(false, b.isSuicide(BoardState::BLACK(), POS(1,0)));

    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(3,0));
    EXPECT_EQ(false, b.isSuicide(BoardState::WHITE(), POS(1,0)));
    EXPECT_EQ(true, b.isSuicide(BoardState::BLACK(), POS(1,0)));
}
...
TEST_F(Empty19, killGroup1) {
    ...
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(0,1));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(1,0));
...
TEST_F(Empty19, kill2Groups) {
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(0,0));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(1,0));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(3,0));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(4,0));

    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(0,1));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(1,1));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(2,1));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(3,1));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(4,1));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(5,0));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(2,0));
...
TEST_F(Empty19, isSimpleEye_corner) {
    EXPECT_EQ(false, b.isSimpleEye(BoardState::BLACK(), POS(0,0)));
...
TEST_F(Empty19, isSimpleEye_wall) {
    EXPECT_EQ(false, b.isSimpleEye(BoardState::BLACK(), POS(2,0)));

    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(1,0));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(2,1));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(3,0));
    EXPECT_EQ(true, b.isSimpleEye(BoardState::BLACK(), POS(2,0)));
...
TEST_F(Empty19, isSimpleEye_open) {
    EXPECT_EQ(false, b.isSimpleEye(BoardState::BLACK(), POS(2,2)));

    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(2,1));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(2,3));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(1,2));
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(3,2));
    EXPECT_EQ(true, b.isSimpleEye(BoardState::BLACK(), POS(2,2)));

    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(1,1));
    EXPECT_EQ(true, b.isSimpleEye(BoardState::BLACK(), POS(2,2)));
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(3,3));
    EXPECT_EQ(false, b.isSimpleEye(BoardState::BLACK(), POS(2,2)));
}
...
TEST(Board3, no_valid_mcgMoves_returns_empty) {
    Board<3> b;
    b.assertGoodState();
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(0,2));
    b.assertGoodState();
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(0,1));
    b.assertGoodState();
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(1,0));
...
TEST(Board2, crash_1) {
    ...
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(0,1));
    b.assertGoodState();
    b.makeMoveAssumeLegal(BoardState::WHITE(), POS(0,0));
    b.assertGoodState();
    b.makeMoveAssumeLegal(BoardState::BLACK(), POS(1,0));
    b.assertGoodState();
}
